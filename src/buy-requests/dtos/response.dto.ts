...
export class BuyRequestArrangeTransitResponseDto extends ApiResponseDto<BuyRequest> {
  ...
  @ApiProperty({
    example: false,
    description:
      'True when AgroTrack could not resolve a sender automatically — fall back to the manual Arrange Transit flow.',
    required: false,
  })
...
export class BuyRequestFindByUserIdResponseDto extends ApiResponseDto<
  BuyRequest[]
> {
